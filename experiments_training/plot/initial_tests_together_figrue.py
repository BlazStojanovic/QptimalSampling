...
ax[0, 1].set_title("Simulation time $T$ vs. loss")
ax[1, 0].set_title("pCNN width vs. loss")
ax[1, 1].set_title("pCNN depth vs. loss")
...
ax[1 ,0].plot(np.arange(len(l3)) + 1, l3, '.--', color='blue', linewidth='1', label="k=3")
ax[1 ,0].plot(np.arange(len(l9)) + 1, l9, '.--', color='green', linewidth='1', label="k=9")
ax[1 ,0].plot(np.arange(len(l15[:-31])) + 1, l15[:-31], '.--', color='red', linewidth='1', label="k=15")
...
ax[1 ,1].plot(np.arange(len(l9)) + 1, l9, '.--', color='green', linewidth='1', label="$N_l=9$")
...
ax[0 ,0].plot(np.arange(len(l10)) + 1, l10, '.--', color='blue', linewidth='1', label="Nb=10")
ax[0 ,0].plot(np.arange(len(l40)) + 1, l40, '.--', color='red', linewidth='1', label="Nb=40")
ax[0 ,0].plot(np.arange(len(l70)) + 1, l70, '.--', color='green', linewidth='1', label="Nb=70")
...
ax[0 ,1].plot(np.arange(len(l100)) + 1, l100, '.--', color='green', linewidth='1', label="T=100")
