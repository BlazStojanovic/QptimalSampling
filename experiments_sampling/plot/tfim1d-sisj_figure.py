...
ax[0].set_title(r"$\langle \hat \sigma^x_i \hat \sigma^x_j \rangle$, $J/h=!!!$")
ax[1].set_title(r"$\langle \hat \sigma^x_i \hat \sigma^x_j \rangle$, $J/h=!!!$")
ax[2].set_title(r"$\langle \hat \sigma^x_i \hat \sigma^x_j \rangle$, $J/h=!!!$")

plt.subplots_adjust(wspace=0.3)
plt.savefig("../../../Thesis/Chapter5/Figs/Raster/tfim1d-sisj-x.png", bbox_inches='tight')
plt.savefig("../figures/tfim1d-sisj-x.png", bbox_inches='tight')
plt.show()